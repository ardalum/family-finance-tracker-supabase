        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-6 text-text-muted">
              WalletFlow is a personal household finance tracker created by Arvin Dalumpines.
              This policy explains what the app is designed to collect, store, and help users
              control.
            </p>
          </div>
        </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-text-muted">
                WalletFlow uses Supabase for account authentication and household data storage.
                Some preferences or legacy backup data may also be stored in the browser. Users
                should protect their login credentials and only use trusted devices.
              </p>
            </div>
          </div>
        </Card>
