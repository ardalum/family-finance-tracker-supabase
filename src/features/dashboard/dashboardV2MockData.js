  ...
  alerts: [
    {
      ...
      description: "$210 spent vs $400 budget",
      action: "View budget",
      tone: "danger",
    },
    {
      title: "High credit utilization",
      description: "Your utilization is above 25%",
      action: "View cards",
      tone: "warn",
    },
    {
      title: "2 bills due soon",
      description: "Total due in next 7 days: $314.33",
      action: "View bills",
      tone: "warn",
    },
  ],
