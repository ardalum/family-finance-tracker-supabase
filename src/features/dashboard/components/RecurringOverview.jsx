...
function getStatusDotClass(status, variableNeedsActual) {
  if (status === "Paid") return "bg-status-success";
  if (status === "Past due") return "bg-status-danger";
  if (["Due now", "Due soon"].includes(status) || variableNeedsActual) return "bg-status-warning";
