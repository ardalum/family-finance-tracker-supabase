export function createAppViewProps({
  ...
  return {
    ...
    spendingProps: {
      ...
      merchantTransactions: householdMerchantTransactions ?? spendingTransactions,
    ...
    calendarProps: {
      ...
      creditCards: supabaseCreditCards,
      monthlyBalances: supabaseMonthlyBalances?.[selectedCalendarMonth] ?? {},
      recurringPayments,
      recurringStatusByMonth,
      incomeEntries,
      incomeSources,
    ...
    financialPositionProps: {
      ...
      onMonthChange: setSelectedFinancialPositionMonth,
      loading: incomeLoading || savingsLoading || accountsLoading || liabilitiesLoading,
      error: incomeError || savingsError || accountsError || liabilitiesError,
    ...
    moneyCenterProps: {
      ...
      onMonthChange: (nextMonth) => {
        setSelectedFinancialPositionMonth?.(nextMonth);
        setSelectedIncomeMonth?.(nextMonth);
        setSelectedAccountsMonth?.(nextMonth);
      },
      loading: incomeLoading || accountsLoading || liabilitiesLoading || savingsLoading,
      error: incomeError || accountsError || liabilitiesError || savingsError,
      transactions: spendingTransactions ?? appData?.transactions,
      spendingOutflowMovements,
      recurringPayments,
      recurringStatusByMonth,
      incomeSources,
      ...
      liabilityBalanceSnapshots,
      householdProfiles,
      isSaving: incomeSaving || accountsSaving,
