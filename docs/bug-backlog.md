...
Last updated: 2026-05-18 (Phase 60 calendar discoverability and release-readiness retest)
...
- Calendar discoverability gap resolved with compact Dashboard quick action + Account menu Tools entry and release-readiness retest runbook (`fixed`, Phase 60)
